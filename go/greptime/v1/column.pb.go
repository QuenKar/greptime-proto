...
type Column struct {
	...
	Datatype *ColumnDataType `protobuf:"bytes,5,opt,name=datatype,proto3" json:"datatype,omitempty"`
}
...
type Column_Values struct {
	...
	DecimalValues              []*Decimal128           `protobuf:"bytes,31,rep,name=decimal_values,json=decimalValues,proto3" json:"decimal_values,omitempty"`
}
...
func (x *Column_Values) GetDecimalValues() []*Decimal128 {
	if x != nil {
		return x.DecimalValues
	}
	return nil
}
...
var file_greptime_v1_column_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc6, 0x0d, 0x0a, 0x06, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x61, 0x74, 0x61, 0x74, 0x79, 0x70, 0x65, 0x1a, 0xd0, 0x0b, 0x0a, 0x06, 0x56, 0x61, 0x6c, 0x75,
	...
	0x63, 0x6f, 0x6e, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x0e, 0x64, 0x65,
	0x63, 0x69, 0x6d, 0x61, 0x6c, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x1f, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x44, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x31, 0x32, 0x38, 0x52, 0x0d, 0x64, 0x65, 0x63,
	0x69, 0x6d, 0x61, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x42, 0x50, 0x0a, 0x0e, 0x69, 0x6f,
...
var file_greptime_v1_column_proto_goTypes = []interface{}{
	...
	(*ColumnDataType)(nil),       // 3: greptime.v1.ColumnDataType
	(*IntervalMonthDayNano)(nil), // 4: greptime.v1.IntervalMonthDayNano
	(*Decimal128)(nil),           // 5: greptime.v1.Decimal128
}
var file_greptime_v1_column_proto_depIdxs = []int32{
	...
	5, // 4: greptime.v1.Column.Values.decimal_values:type_name -> greptime.v1.Decimal128
