...
func (x *Value) GetDecimalValue() *Decimal128 {
	if x, ok := x.GetValueData().(*Value_DecimalValue); ok {
...
type Value_DecimalValue struct {
	DecimalValue *Decimal128 `protobuf:"bytes,31,opt,name=decimal_value,json=decimalValue,proto3,oneof"`
}
...
func (*Value_DecimalValue) isValue_ValueData() {}
...
var file_greptime_v1_row_proto_rawDesc = []byte{
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xe3, 0x0b,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x3e, 0x0a, 0x0d, 0x64, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c,
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67,
	0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x63, 0x69, 0x6d,
	0x61, 0x6c, 0x31, 0x32, 0x38, 0x48, 0x00, 0x52, 0x0c, 0x64, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c,
...
var file_greptime_v1_row_proto_depIdxs = []int32{
	...
	7, // 6: greptime.v1.Value.decimal_value:type_name -> greptime.v1.Decimal128
