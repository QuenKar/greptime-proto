...
type SubmitDdlTaskRequest struct {
	...
	//	*SubmitDdlTaskRequest_CreateDatabaseTask
...
func (x *SubmitDdlTaskRequest) GetCreateDatabaseTask() *CreateDatabaseTask {
	if x, ok := x.GetTask().(*SubmitDdlTaskRequest_CreateDatabaseTask); ok {
...
type SubmitDdlTaskRequest_CreateDatabaseTask struct {
	CreateDatabaseTask *CreateDatabaseTask `protobuf:"bytes,6,opt,name=create_database_task,json=createDatabaseTask,proto3,oneof"`
}
...
func (*SubmitDdlTaskRequest_CreateDatabaseTask) isSubmitDdlTaskRequest_Task() {}
...
var file_greptime_v1_meta_ddl_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x5e, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x48, 0x0a, 0x0f,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18,
	...
	0x73, 0x65, 0x45, 0x78, 0x70, 0x72, 0x52, 0x0e, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x22, 0xf2, 0x03, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x6d, 0x69,
	...
	,
	...
	0x79, 0x12, 0x34, 0x0a, 0x08, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x52, 0x07,
	...
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x72, 0x6f, 0x70, 0x10, 0x01, 0x32, 0x6b, 0x0a, 0x07,
	0x44, 0x64, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x60, 0x0a, 0x0d, 0x53, 0x75, 0x62, 0x6d, 0x69,
	0x74, 0x44, 0x64, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x26, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74,
	0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x53, 0x75, 0x62, 0x6d,
	...
	0x65, 0x74, 0x61, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x44, 0x64, 0x6c, 0x54, 0x61, 0x73,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74,
...
var file_greptime_v1_meta_ddl_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_greptime_v1_meta_ddl_proto_goTypes = []interface{}{
	...
	(*CreateDatabaseTask)(nil),    // 5: greptime.v1.meta.CreateDatabaseTask
	(*SubmitDdlTaskRequest)(nil),  // 6: greptime.v1.meta.SubmitDdlTaskRequest
	(*SubmitDdlTaskResponse)(nil), // 7: greptime.v1.meta.SubmitDdlTaskResponse
	(*v1.CreateTableExpr)(nil),    // 8: greptime.v1.CreateTableExpr
	(*Partition)(nil),             // 9: greptime.v1.meta.Partition
	(*v1.DropTableExpr)(nil),      // 10: greptime.v1.DropTableExpr
	(*v1.AlterExpr)(nil),          // 11: greptime.v1.AlterExpr
	(*v1.TruncateTableExpr)(nil),  // 12: greptime.v1.TruncateTableExpr
	(*v1.CreateDatabaseExpr)(nil), // 13: greptime.v1.CreateDatabaseExpr
	(*RequestHeader)(nil),         // 14: greptime.v1.meta.RequestHeader
	(*ResponseHeader)(nil),        // 15: greptime.v1.meta.ResponseHeader
	(*TableId)(nil),               // 16: greptime.v1.meta.TableId
}
var file_greptime_v1_meta_ddl_proto_depIdxs = []int32{
	8,  // 0: greptime.v1.meta.CreateTableTask.create_table:type_name -> greptime.v1.CreateTableExpr
	9,  // 1: greptime.v1.meta.CreateTableTask.partitions:type_name -> greptime.v1.meta.Partition
	10, // 2: greptime.v1.meta.DropTableTask.drop_table:type_name -> greptime.v1.DropTableExpr
	11, // 3: greptime.v1.meta.AlterTableTask.alter_table:type_name -> greptime.v1.AlterExpr
	12, // 4: greptime.v1.meta.TruncateTableTask.truncate_table:type_name -> greptime.v1.TruncateTableExpr
	13, // 5: greptime.v1.meta.CreateDatabaseTask.create_database:type_name -> greptime.v1.CreateDatabaseExpr
	14, // 6: greptime.v1.meta.SubmitDdlTaskRequest.header:type_name -> greptime.v1.meta.RequestHeader
	1,  // 7: greptime.v1.meta.SubmitDdlTaskRequest.create_table_task:type_name -> greptime.v1.meta.CreateTableTask
	2,  // 8: greptime.v1.meta.SubmitDdlTaskRequest.drop_table_task:type_name -> greptime.v1.meta.DropTableTask
	3,  // 9: greptime.v1.meta.SubmitDdlTaskRequest.alter_table_task:type_name -> greptime.v1.meta.AlterTableTask
	4,  // 10: greptime.v1.meta.SubmitDdlTaskRequest.truncate_table_task:type_name -> greptime.v1.meta.TruncateTableTask
	5,  // 11: greptime.v1.meta.SubmitDdlTaskRequest.create_database_task:type_name -> greptime.v1.meta.CreateDatabaseTask
	15, // 12: greptime.v1.meta.SubmitDdlTaskResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	16, // 13: greptime.v1.meta.SubmitDdlTaskResponse.table_id:type_name -> greptime.v1.meta.TableId
	6,  // 14: greptime.v1.meta.DdlTask.SubmitDdlTask:input_type -> greptime.v1.meta.SubmitDdlTaskRequest
	7,  // 15: greptime.v1.meta.DdlTask.SubmitDdlTask:output_type -> greptime.v1.meta.SubmitDdlTaskResponse
...
func file_greptime_v1_meta_ddl_proto_init() {
	...
	file_greptime_v1_meta_ddl_proto_msgTypes[5].OneofWrappers = []interface{}{
		...
		(*SubmitDdlTaskRequest_CreateDatabaseTask)(nil),
	}
	type x struct{}
