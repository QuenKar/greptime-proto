...
PROTOBUF_CONSTEXPR Column_Values::Column_Values(
  ...
  , /*decltype(_impl_.decimal_values_)*/{}
...
const uint32_t TableStruct_greptime_2fv1_2fcolumn_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::greptime::v1::Column_Values, _impl_.decimal_values_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fcolumn_2eproto = {
    false, false, 1277, descriptor_table_protodef_greptime_2fv1_2fcolumn_2eproto,
...
void Column_Values::clear_decimal_values() {
  _impl_.decimal_values_.Clear();
}
...
Column_Values::Column_Values(const Column_Values& from)
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._duration_nanosecond_values_cached_byte_size_)*/{0}
    , decltype(_impl_.decimal_values_){from._impl_.decimal_values_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void Column_Values::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._duration_nanosecond_values_cached_byte_size_)*/{0}
    , decltype(_impl_.decimal_values_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void Column_Values::SharedDtor() {
  ...
  _impl_.decimal_values_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 31:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 250)) {
          ...
          do {
            ptr += 2;
            ptr = ctx->ParseMessage(_internal_add_decimal_values(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* Column_Values::_InternalSerialize(
  ...
  // repeated .greptime.v1.Decimal128 decimal_values = 31;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_decimal_values_size()); i < n; i++) {
    const auto& repfield = this->_internal_decimal_values(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.Column.Values)
  ...
  // repeated .greptime.v1.Decimal128 decimal_values = 31;
  total_size += 2UL * this->_internal_decimal_values_size();
  for (const auto& msg : this->_impl_.decimal_values_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void Column_Values::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.decimal_values_.MergeFrom(from._impl_.decimal_values_);
...
void Column_Values::InternalSwap(Column_Values* other) {
  ...
  _impl_.decimal_values_.InternalSwap(&other->_impl_.decimal_values_);
}
...
class Column::_Internal {
 public:
  ...
  static const ::greptime::v1::ColumnDataType& datatype(const Column* msg);
};
...
Column::_Internal::datatype(const Column* msg) {
  return *msg->_impl_.datatype_;
}
void Column::clear_datatype() {
...
uint8_t* Column::_InternalSerialize(
  ...
  if (this->_internal_has_datatype()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(5, _Internal::datatype(this),
...
void Column::InternalSwap(Column* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Column, _impl_.semantic_type_)
      + sizeof(Column::_impl_.semantic_type_)
