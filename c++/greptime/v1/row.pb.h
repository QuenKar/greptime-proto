...
// .greptime.v1.ColumnDataType datatype = 2;
inline bool ColumnSchema::_internal_has_datatype() const {
  return this != internal_default_instance() && _impl_.datatype_ != nullptr;
}
inline bool ColumnSchema::has_datatype() const {
  return _internal_has_datatype();
}
inline const ::greptime::v1::ColumnDataType& ColumnSchema::_internal_datatype() const {
...
inline const ::greptime::v1::ColumnDataType& ColumnSchema::datatype() const {
  // @@protoc_insertion_point(field_get:greptime.v1.ColumnSchema.datatype)
  return _internal_datatype();
}
inline void ColumnSchema::unsafe_arena_set_allocated_datatype(
    ::greptime::v1::ColumnDataType* datatype) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.ColumnSchema.datatype)
}
inline ::greptime::v1::ColumnDataType* ColumnSchema::release_datatype() {
...
inline ::greptime::v1::ColumnDataType* ColumnSchema::unsafe_arena_release_datatype() {
  // @@protoc_insertion_point(field_release:greptime.v1.ColumnSchema.datatype)
  
  ::greptime::v1::ColumnDataType* temp = _impl_.datatype_;
  _impl_.datatype_ = nullptr;
  return temp;
}
inline ::greptime::v1::ColumnDataType* ColumnSchema::_internal_mutable_datatype() {
...
inline ::greptime::v1::ColumnDataType* ColumnSchema::mutable_datatype() {
  ::greptime::v1::ColumnDataType* _msg = _internal_mutable_datatype();
  // @@protoc_insertion_point(field_mutable:greptime.v1.ColumnSchema.datatype)
  return _msg;
}
inline void ColumnSchema::set_allocated_datatype(::greptime::v1::ColumnDataType* datatype) {
  ...
  _impl_.datatype_ = datatype;
  // @@protoc_insertion_point(field_set_allocated:greptime.v1.ColumnSchema.datatype)
}
